...
namespace cfaresv2.Api
{
    ...
    public class GuestTicketController : RepositoryEntitySetController<TicketRepository<GuestTicket>, GuestTicket, int,ITicket>
    {

        protected override TicketRepository<GuestTicket> GetRepository(IResContext context, 
        ...
        {
            return new Collection<GuestTicket>().AsQueryable();
        }
