...
namespace cfaresv2.Api
{
    ...
    public class ReservationCategoryController : RepositoryEntitySetController<ReservationCategoryRepository, ReservationCategory, int>
    {

        protected override ReservationCategoryRepository GetRepository(IResContext context,
            System.Web.Http.Controllers.HttpControllerContext httpController = null)
        {
            return new ReservationCategoryRepository(context);
        }
