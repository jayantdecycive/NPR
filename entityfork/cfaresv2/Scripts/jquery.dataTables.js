    ...
    var DataTable = function (oInit) {
        ...
        */
        function _fnSetCellData(oSettings, iRow, iCol, val) {
            ...
            var oData = oSettings.aoData[iRow]._aData;
            //MDRAKE
            return oCol.fnSetData(oData, val);
        }
        ...
        */
        function _fnGetObjectDataFn(mSource) {
            if (mSource === null) {
                ...
                return function (data, type) {
                    //MDRAKE
                    return mSource.call(this.nTh, data, type);
                };
            }
        ...
        */
        function _fnSetObjectDataFn(mSource) {
            if (mSource === null) {
                ...
                return function (data, val) {
                    //MDRAKE
                    var setted = mSource.call(this.nTh, data, 'set', val);
                    return setted;
                };
            }
            else if (typeof mSource === 'string' && mSource.indexOf('.') != -1) {
                ...
                */
                ...
                for (var i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                    ...
                    */
                    ...
                    if (oCol.sClass !== null) {                       
                            if ($.inArray('Specialty', oData._aData) != -1 && $.inArray('Cancelled', oData._aData) != -1) {
                                 nTd.className = "SpecialtyCancelled";
                            }
                            else
                            {
        ...
        */
        function _fnScrollDraw(o) {
            ...
            */
            ...
            iSanityWidth = $(o.nTable).outerWidth(false);
            if (o.oScroll.sX === "") {
                /* No x scrolling */
                ...
                */
                if (ie67 && ($('tbody', nScrollBody).height() > nScrollBody.offsetHeight ||
                    ...
                    o.nTable.style.width = _fnStringToCss($(o.nTable).outerWidth(false) - o.oScroll.iBarWidth);
                }
            }
            else {
                if (o.oScroll.sXInner !== "") {
				   ...
				   $(nScrollBody).height() < $(o.nTable).height()) {
                    ...
                    if ($(o.nTable).outerWidth(false) > iSanityWidth - o.oScroll.iBarWidth) {
            ...
            */
            if ($(o.nTable).outerWidth(false) < iSanityWidth) {
            ...
            */
            ...
            var iOuterWidth = $(o.nTable).outerWidth(false);
            ...
            if (iColums == oHeaders.length && iUserInputs === 0 && iVisibleColumns == iColums &&
                ...
                */
                    ...
                    for (i = 0; i < oSettings.aoColumns.length; i++) {
                        if (oSettings.aoColumns[i].bVisible) {
                            if (oSettings.aoColumns[i].sWidthOrig === null) {
                                iTotal += $(oNodes[iCorrector]).outerWidth(false);
                            }
                            else {
                                iTotal += parseInt(oSettings.aoColumns[i].sWidth.replace('px', ''), 10) +
									($(oNodes[iCorrector]).outerWidth(false) - $(oNodes[iCorrector]).width());
                            }
                            iCorrector++;
                        }
                    }
                ...
                oSettings.nTable.style.width = (cssWidth.indexOf('%') !== -1) ?
				    cssWidth : _fnStringToCss($(nCalcTmp).outerWidth(false));
        ...
        function _fnScrollingWidthAdjust(oSettings, n) {
            if (oSettings.oScroll.sX === "" && oSettings.oScroll.sY !== "") {
                ...
                */
                ...
                n.style.width = _fnStringToCss($(n).outerWidth(false) - oSettings.oScroll.iBarWidth);
            }
            else if (oSettings.oScroll.sX !== "") {
                /* When x-scrolling both ways, fix the table at it's current size, without adjusting */
                n.style.width = _fnStringToCss($(n).outerWidth(false));
            }
        }
        ...
        */
        function _fnLog(oSettings, iLevel, sMesg) {
            var sAlert = (oSettings === null) ?
				"DataTables warning (1): " + sMesg :
				"DataTables warning (2) (table id = '" + oSettings.sTableId + "'): " + sMesg;
        ...
        */
        this.fnDraw = function (bComplete) {
            var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
            //mdrake: looks like we end up with some ghost tables
            if (!oSettings)
                return;
            if (bComplete) {
                _fnCalculateEnd(oSettings);
        ...
        */
        this.fnFilter = function (sInput, iColumn, bRegex, bSmart, bShowGlobal, bCaseInsensitive) {
            var oSettings = _fnSettingsFromNode(this[DataTable.ext.iApiIndex]);
            //mdrake whytf did I need to do this?
            if (!oSettings.oFeatures||!oSettings.oFeatures.bFilter) {
                return;
            }
        ...
        */
        this.fnSetColumnVis = function (iCol, bShow, bRedraw) {
            var node = this[DataTable.ext.iApiIndex];
            var oSettings = _fnSettingsFromNode(node);
        ...
        */
        this.fnUpdate = function (mData, mRow, iColumn, bRedraw, bAction) {
            ...
            if (oSettings.__fnUpdateDeep === undefined && $.isArray(mData) && typeof mData === 'object') {
                ...
                //MDRAKE
                var setted = _fnSetCellData(oSettings, iRow, iColumn, mData);
