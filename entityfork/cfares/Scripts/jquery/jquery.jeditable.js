                    ...
                    if (false !== onsubmit.apply(form, [settings, self])) {
                        ...
                        if (false !== submit.apply(form, [settings, self])) {
                            ...
                            if ($.isFunction(settings.target)) {
                                var str = settings.target.apply(self, [input.val(), settings, callback, self, [input.val(), settings]]);
                                $(self).html(str);
                                self.editing = false;
                                /* MDRAKE: Passed callback as an argument so I can call back at will */
                                //callback.apply(self, [self.innerHTML, settings]);
                                /* TODO: this is not dry */
                                /* MDRAKE: No It's not! I got this, thx */
                                if (!$.trim($(self).html())) {
